    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          >
            <ArrowLeft className="w-3.5 h-3.5 text-slate-400 dark:text-slate-400 group-hover:text-rose-500 dark:group-hover:text-rose-500 group-hover:-translate-x-0.5 transition-transform duration-300" /> Back
          </Button>
          <div>
